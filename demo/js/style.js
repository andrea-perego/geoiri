...
// Navbar        
  $("nav").append('<p><a href="../../..">GeoIRI</a></p><ul id="actions"><li id="geoiri-edit"><a href="#" title="Edit geometry">Geometry</a></li><li id="format-list"><a href="#" title="Available formats">Formats</a></li></ul><ul id="info"><li id="about"><a href="#">About</a></li></ul>');
